...
* Where do I write my tests?
  * You can write your tests next to your component files. See [`/src/app/home/colormodeltransform.component.spec.ts`](/src/app/colormodeltransform/colormodeltransform.component.spec.ts)
